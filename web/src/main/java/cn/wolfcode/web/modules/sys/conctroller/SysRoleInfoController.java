...
public class SysRoleInfoController {
    ...
    public ResponseEntity page(LayuiPage layuiPage, SysRoleInfo sysRoleInfo) {
        ...
        page.setRecords(sysRoleInfoService.list(sysRoleInfoService.lambdaQuery()
                .like(StringUtils.isNotBlank(sysRoleInfo.getRoleName()), SysRoleInfo::getRoleName, sysRoleInfo.getRoleName()).getWrapper()));
