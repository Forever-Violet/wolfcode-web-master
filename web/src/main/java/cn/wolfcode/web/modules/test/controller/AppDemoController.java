...
import cn.wolfcode.web.modules.report.entity.AppDemo;
import cn.wolfcode.web.modules.report.service.IAppDemoService;
...
public class AppDemoController extends BaseController {
    ...
    public String list() {
        return "sys/appdemo/list";
    }

    @RequestMapping("/add.html")
    @PreAuthorize("hasAuthority('sys:appdemo:add')")
    public ModelAndView toAdd(ModelAndView mv) {
        mv.setViewName("sys/appdemo/add");
        return mv;
    }

    @GetMapping("/{id}.html")
    @PreAuthorize("hasAuthority('sys:appdemo:update')")
    public ModelAndView toUpdate(@PathVariable("id") String id, ModelAndView mv) {
        mv.setViewName("sys/appdemo/update");
    ...
    @RequestMapping("list")
    @PreAuthorize("hasAuthority('sys:appdemo:list')")
    ...
    @PreAuthorize("hasAuthority('sys:appdemo:delete')")
