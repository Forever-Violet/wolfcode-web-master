...
<#--                    <input type="text"
                    ...
                    <input type="hidden" name="age" value="${obj.age}">
                </div>
                ...
                <div class="layui-input-line">
                    <select name="jobStatus">
                        <option <#if obj.jobStatus==1>selected</#if> value="1">在职</option>
                        <option <#if obj.jobStatus==0>selected</#if> value="0">离职</option>
                    </select>
                </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/custLinkman/linkmanInfo/update.js?_=${randomNum}"></script>
</body>
