    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <@sec.authenticate grants="sys:appdemo:list">
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="List-toolbar">
                        <div class="layui-btn-container">
                            <@sec.authenticate grants="sys:appdemo:add">
...
<script type="text/javascript" src="${request.contextPath}/scripts/sys/appdemo/list.js?_=${randomNum}"></script>
</body>
</html>
