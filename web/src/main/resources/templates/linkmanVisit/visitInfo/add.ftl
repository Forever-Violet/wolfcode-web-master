...
<#--                <div class="layui-col-lg6">
                ...
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        ...
                        <input type="text" name="visitDate" class="layui-input" id="ID-laydate-demo" placeholder="yyyy-MM-dd">
                    </div>
                </div>
...
<script type="text/javascript" src="${request.contextPath}/scripts/linkmanVisit/visitInfo/add.js?_=${randomNum}"></script>
</body>
