            ...
            <div class="layui-row layui-col-space10 layui-form-item">
                ...
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="Add-filter">确定</button>
...
<script type="text/javascript" src="${request.contextPath}/scripts/custContract/custContractInfo/affixSeal.js?_=${randomNum}"></script>
</body>
