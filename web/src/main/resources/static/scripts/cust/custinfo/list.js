layui.use(['form', 'layer', 'table', 'laytpl', 'laydate'], function () {
                    ...
                    {field: 'registerDate', title: '成立时间', minWidth: 100, align: "center"},
                    {
                        field: 'openStatus', title: '经营状态', minWidth: 100, align: "center", templet: function (d) {
                            if (d.openStatus == '0') {
                                ...
                                return "<button class=\"layui-btn layui-btn-normal layui-btn-xs\" style='background-color: #ffb800'>注销</button>";
                            } else {
                                return "<button class=\"layui-btn layui-btn-normal layui-btn-xs\" style='background-color: #ff5722'>破产</button>";
                            }
                        }
                    },
    ...
    table.on('toolbar(List-toolbar)', function (obj) {
        ...
        if(obj.event == 'export'){
            ...
            var eix;
            $.fileDownload(web.rootPath() + "custinfo/export?parameterName="+ parameterName +"&province="+ province +"&openStatus="+ openStatus, {
                //+"&province="+province
                httpMethod: 'POST',
                // data: buildCondition(),
